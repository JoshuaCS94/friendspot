...
export const Available20x20 = () => (
  <AvailabilityIndicator available className='h-5 w-5' />
)

export const Unavailable20x20 = () => (
  <AvailabilityIndicator available={false} className='h-5 w-5' />
)
